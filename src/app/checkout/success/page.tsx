...
async function getPaymentStatus(sessionId: string | undefined): Promise<{
  paid: boolean;
  ref: string | null;
  totalUsd: number;
  items: PurchaseItem[];
  ...
  return (
    <Section bg="white">
      <Container>
        ...
        {/* GA4 purchase — server-verified paid sessions only, deduped per
            session id inside the tracker. */}
        {paid && session_id && (
          <PurchaseTracker
